    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-8 text-white">
        <div className="flex items-center justify-center mb-4">
          <div className="h-24 w-24 rounded-full bg-white flex items-center justify-center text-blue-900 shadow-lg">
      ...
      <div className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-50 p-5 rounded-lg border border-blue-100 shadow-sm">
            <h3 className="text-sm uppercase tracking-wider font-semibold text-blue-900 mb-4 flex items-center">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="flex-shrink-0 h-8 w-8 rounded-md bg-blue-900 flex items-center justify-center text-white">
                ...
                <div className="ml-3">
                  ...
                  <a href={`mailto:${user.email}`} className="text-blue-900 hover:underline font-medium">
                    {user.email}
                  </a>
                </div>
              </div>
